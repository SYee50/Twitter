...
//    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "5lUJuO5AUpPUCez4ewYDFrtgh", consumerSecret: "s5ynGqXzstUZwFPxVyMDkYh197qvHOcVM3kwv1o2TKhS1avCdS")
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "aemTD4EhJ3eLvru8BDnSQON52", consumerSecret: "ctIlPhCI5LMz29Dc0cbhkLuDFlsv4C1Amb3BxSWigEJ32ZbG9q")
    var loginSuccess: (() -> ())?
